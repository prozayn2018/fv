...
class MarketsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create market" do
    assert_difference('Market.count') do
      post markets_url, params: { market: { YTD_change: @market.YTD_change, current_price: @market.current_price, discount_value: @market.discount_value, fair_value: @market.fair_value, integer: @market.integer, name: @market.name } }
    end
  ...
  test "should update market" do
    patch market_url(@market), params: { market: { YTD_change: @market.YTD_change, current_price: @market.current_price, discount_value: @market.discount_value, fair_value: @market.fair_value, integer: @market.integer, name: @market.name } }
